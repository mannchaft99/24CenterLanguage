    ...
    private class FetchData extends AsyncTask<Void, Void, List<ResultModel>> {
        ...
        protected List<ResultModel> doInBackground(Void... voids) {
            ...
            try {
                ...
                String link = "http://192.168.1.12/android_db_pool/get_result/get_result_" + anyClass  + ".php";
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    ResultModel result = new ResultModel(id, name, ktra_1, ktra_2, ktra_3, test_1, test_2);
