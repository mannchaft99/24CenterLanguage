...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.stt_student.setText(model.getStt());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView stt_student, id_student, name_student, sex_student, birth_day, class_name, details_student;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            stt_student = itemView.findViewById(R.id.stt_student);
    ...
    private class FetchData extends AsyncTask<Void, Void, List<StudentModel>> {
        ...
        protected List<StudentModel> doInBackground(Void... voids) {
            ...
            try {
                ...
                String link = "http://192.168.1.12/android_db_pool/get_data/get_data_" + anyClass  + ".php";
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    StudentModel student = new StudentModel(stt, id, name, sex, birthDay, className, details);
